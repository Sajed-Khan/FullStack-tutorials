...
const r = {
    ...
    greet: function(){
        ...
        //can't assign greet function to other function using = cuz loses track of what the original "this" was
    },
    doAdd: function(a,b){
        console.log(a+b)
    }
...
r.grow()
console.log(r.age)
setTimeout(r.greet,1000) //leads to disappearance of this cuz the this refers to global object
setTimeout(r.greet.bind(r),1000) //original this is preserved using bind by creating a new function where this is bound
                                //to point at r no matter where and how the method is called
...
const Adam =new Person('adam ib,35')
Adam.greet()
